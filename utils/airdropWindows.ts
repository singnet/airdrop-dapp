...
export const AIRDROP_INELIGIBILITY_REASON_STRING = 'Sorry, You are not qualified for this airdrop window. Please check the rules and schedule for the next window';
