...
export default function Airdropinfo({ blogLink }: Props) {
  return (
    <Box>
      <Typography align="center" fontWeight="bold" variant="h3" color="bgtext.main">
      ...
      {blogLink ? (
        <Box sx={{ textAlign: "center" }}>
          <Button variant="outlined" color="info" href={blogLink} target="_blank" rel="noreferrer noopener">
            Read Whitepaper
          </Button>
        </Box>
      ) : null}
